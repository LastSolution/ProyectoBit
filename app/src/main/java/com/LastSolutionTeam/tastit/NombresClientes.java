    ...
    private void INGRESARCLIENTES(int Cantidad){
        ...
        switch (Cantidad){
            ...
            case 4:
                ...
                VarGlobales.setCliente1(Cliente.BuscarCliente(Cliente.IngresarCliente(Nombre1,"")));
                VarGlobales.setCliente2(Cliente.BuscarCliente(Cliente.IngresarCliente(Nombre2,"")));
                VarGlobales.setCliente3(Cliente.BuscarCliente(Cliente.IngresarCliente(Nombre3,"")));
                VarGlobales.setCliente4(Cliente.BuscarCliente(Cliente.IngresarCliente(Nombre4,"")));
                CrearpedidosClientes(VarGlobales.getCliente1());
                CrearpedidosClientes(VarGlobales.getCliente2());
                CrearpedidosClientes(VarGlobales.getCliente3());
                CrearpedidosClientes(VarGlobales.getCliente4());
                break;
